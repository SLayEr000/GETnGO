...
// JitStringEncoding and may go away in the future.
// Please consider using JitStringEncoding instead.
...
//
@interface JitKCBase64 : NSObject
...
+(BOOL)isBase64EncodePadding:(NSData *)data;

+(BOOL)isBase64URLEncode:(NSData *)data;

+(BOOL)isBase64URLEncodePadding:(NSData *)data;
